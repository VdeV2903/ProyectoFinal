...
public class MainActivity extends AppCompatActivity {
    ...
    String uidQuered="default";
    public void loginFinal(){
        try{
            if(sesion.isChecked()){
                BDConnection bd = new BDConnection(this,"bitacora",null,1);
                SQLiteDatabase baseBitacora = bd.getWritableDatabase();
                String loginQuery = "SELECT UID FROM usuarios WHERE Usuario = '"+userExt+"' AND Contraseña = '"+passExt+"'";
                Cursor datos = baseBitacora.rawQuery(loginQuery,null);
                ...
                if (datos.moveToFirst()) {
                    ...
                    Toast.makeText(this,uidQuered, Toast.LENGTH_LONG).show();
                }
            }
